...
##### Control-[PDF file](/presentation.pdf) 
...
The following [PDF file](/slides.pdf) contains a brief description of the processor simulator along with the different experiments and benchmarks performed on this project